...
import com.eczema.cloud.constant.CommonConstants;
import com.eczema.cloud.entity.ColumnEntity;
import com.eczema.cloud.entity.GenConfig;
import com.eczema.cloud.entity.TableEntity;
...
public class GenUtils {
     ...
     * 生成代码
     */
    public void generatorCode2(Map<String, String> table,
                               List<Map<String, String>> columns, ZipOutputStream zip) {
        //配置信息
        Configuration config = getConfig();
        boolean hasBigDecimal = false;
